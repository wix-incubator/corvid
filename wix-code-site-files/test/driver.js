...
const createFile = (relativePath, content) => fs.writeFileSync(path.resolve(getBasePath(), relativePath), content) 
const deleteFile = (relativePath) => fs.unlinkSync(path.resolve(getBasePath(), relativePath))
