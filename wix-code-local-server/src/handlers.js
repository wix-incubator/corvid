...
module.exports = {
    ...
    [socketActions.IS_CLONE_MODE]: (localServerDriver, requestPayload, callback) =>
        ...
        .push(handlerWrapper(localServerDriver, requestPayload, actions.isCloneMode, callback)),
    [socketActions.GET_DOCUMENT]: (localServerDriver, requestPayload, callback) =>
        localServerDriver
        .getRequestTaskRunner()
        .push(handlerWrapper(localServerDriver, requestPayload, actions.getDocument, callback)),
    [socketActions.OVERRIDE_DOCUMENT]: (localServerDriver, requestPayload, callback) =>
        localServerDriver
        .getRequestTaskRunner()
        .push(handlerWrapper(localServerDriver,requestPayload,actions.overrideDocument,callback)),
    [socketActions.GET_CODE]: (localServerDriver, requestPayload, callback) =>
        localServerDriver
        .getRequestTaskRunner()
        .push(handlerWrapper(localServerDriver, requestPayload, actions.getCode, callback)),
    [socketActions.UPDATE_CODE]: (localServerDriver, requestPayload, callback) =>
        localServerDriver
        .getRequestTaskRunner()
        .push(handlerWrapper(localServerDriver, requestPayload, actions.updateCode, callback))
}
