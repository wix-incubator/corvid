...
describe("create", () => {
  ...
  beforeAll(async () => {
    ...
    createCorvidApp = args => runCreateCorvidApp(args, fakeNpmRegistry);
  });
  ...
  describe("project template", () => {
    it("should create the given directory if it doesn't exist", async () => {
      ...
      await createCorvidApp(projectDir);
    ...
    it("should fail working with a non-empty directory", async () => {
      ...
      const { stderr } = await createCorvidApp(projectDir).catch(err => err);
  ...
  describe("output", () => {
    it("should output relevant execution steps", async () => {
      const projectDir = await initTempDir();
      const { stdout } = await createCorvidApp(projectDir);
